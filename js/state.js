...
export function normalizeState(candidate, initialState) {
  ...
  if (!["all", "open"].includes(normalized.settings.subtaskExpandMode)) {
    normalized.settings.subtaskExpandMode = initialState.settings.subtaskExpandMode;
  }
